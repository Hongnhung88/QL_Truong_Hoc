...
<a href="/Mon_Hoc">Danh Sách Môn Học</a>
<section class="section-conten padding-y" style="min-height:84vh">
		<div class="card mx-auto" style="max-width: 380px; margin-top:40px;">
      	<div class="card-body">
      	<h4 class="card-title">Sửa thông tin môn học</h4>
          ...
          <div class="form-group">
			...
			<input name="Ten_Mon" class="form-control" placeholder="Tenmonhoc" type="text"><br>
          </div> <!-- form-group// -->
