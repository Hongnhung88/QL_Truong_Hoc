 ...
 */
@WebServlet(urlPatterns = {"/sinh_vien", "/Sinh_Vien", "/sinhvien"})
public class Sinh_Vien_Servlet extends HttpServlet {
            ...
            throws ServletException, IOException 
    {
        ...
        try {
            ...
            request.setAttribute("DataTable",Sinh_Vien.List());
            request.setAttribute("web_title","Trang Chủ");
            request.setAttribute("web_content","Sinh_Vien/home_Sinh_Vien.jsp");
