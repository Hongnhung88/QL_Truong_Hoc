 ...
 */
@WebServlet(urlPatterns = {"/Them_Sinh_Vien", "/them_sinh_vien","/théminhvien"})
public class Them_Sinh_Vien_Servlet extends HttpServlet {
...
//           out.close();
        ...
        try {
        	request.setAttribute("DataClass",Lop_Hoc.List());
            request.setAttribute("web_title","ThÃªm Má»›i"); // Tá»±a Ä‘á»? Web
            request.setAttribute("web_content","Sinh_Vien/add_Sinh_Vien.jsp"); // Ná»™i dung Web
            ...
            throws ServletException, IOException 
    {
        ...
        try 
        {
            ...
            session.setAttribute("SUCCESS_MSG", "Thêm mới sinh viên hoàn tất !");
