 ...
 */
@WebServlet(urlPatterns = {"/Them_Ket_Qua_Thi", "/them_ket_qua_thi","/themketquathi"})
public class Them_Ket_Qua_Thi_Servlet extends HttpServlet {
...
//           out.close();
        ...
        request.setAttribute("web_content","Ket_Qua_Thi/add_Ket_Qua_Thi.jsp"); // Nội dung Web
