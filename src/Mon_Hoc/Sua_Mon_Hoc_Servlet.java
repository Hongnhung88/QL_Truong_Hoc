 ...
 */
@WebServlet(urlPatterns = {"/Sua_Mon_Hoc", "/sua_mon_hoc"})
public class Sua_Mon_Hoc_Servlet extends HttpServlet {
            ...
            throws ServletException, IOException 
    {
        ...
        try {
            ...
            request.setAttribute("web_content","Mon_Hoc/edit_Mon_Hoc.jsp");
