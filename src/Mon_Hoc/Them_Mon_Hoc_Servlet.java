 ...
 */
@WebServlet(urlPatterns = {"/Them_Mon_Hoc", "/them_mon_hoc"})
public class Them_Mon_Hoc_Servlet extends HttpServlet {
...
//           out.close();
        ...
        request.setAttribute("web_content","Mon_Hoc/add_Mon_Hoc.jsp"); // Nội dung Web
