 ...
 */
@WebServlet(urlPatterns = {"/mon_hoc", "/Mon_Hoc", "/monhoc"})
public class Mon_Hoc_Servlet extends HttpServlet {
            ...
            throws ServletException, IOException 
    {
        ...
        try {
            ...
            request.setAttribute("DataTable",Mon_Hoc.List());
            request.setAttribute("web_title","Trang Chủ");
            request.setAttribute("web_content","Mon_Hoc/home_Mon_Hoc.jsp");
